...
class Module extends CI_Controller
{
    ...
    public function createModule()
    {
        ...
        foreach ($data['tbl_pre_module_temp'] as $key => $row) {
            ...
            $question_list[$key]['order'] = $row['question_order'];
    ...
    public function detailsModule()
    {
        ...
        $data['all_module_questions'] = $this->ModuleModel->getTblNewModule();
    ...
    public function saveNewModuleQuestion()
    {
        ...
        // Save module info first
        $moduleId = $this->ModuleModel->insert('tbl_new_module', $moduleTableData);
        $module_insert_id = $this->db->insert_id();
        ...
        if (count($items)) {
            ...
            $this->ModuleModel->insert('tbl_new_modulequestion', $arr);
        ...
        if ($clean['moduleType'] == 2) {
            ...
            $repetition_days = json_encode($a);
            $this->db->where('id', $module_insert_id)->update('tbl_new_module', ['repetition_days' => $repetition_days]);
        }
    ...
    public function newModuleDuplicate()
    {
        ...
        $moduleId = $this->ModuleModel->insert('tbl_new_module', $items);
        echo 'success';

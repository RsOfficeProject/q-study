...
class Student extends CI_Controller
{
    ...
    public function st_creative_ans_save()
    {
        ...
        if($user_type==3){
            ...
            $check_idea = $this->Student_model->checkIdeaAns($module_id,$question_id,$idea_id,$user_id);
        }
    ...
    public function submited_student_idea(){ 
        ...
        $data['get_idea'] = $this->Student_model->get_submited_student_idea($student_id,$question_id,$module_id);
    ...
    public function submited_tutor_idea(){
        ...
        $data['profile_info'] = $this->Student_model->get_profile_information_tutor($tutor_id,$idea_id);
        ...
        $data['idea_information'] = $this->Student_model->get_idea_information_tutor($idea_id,$tutor_id,$idea_no);

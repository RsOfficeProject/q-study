...
//        echo $this->db->last_query();
    ...
    {
        if($user_type==3){
            $this->db->insert('idea_tutor_ans', $data);
            $insert_id = $this->db->insert_id();
            return $insert_id;
        }else{

        $this->db->insert('idea_student_ans', $data);
        $insert_id = $this->db->insert_id();
        return $insert_id;
    ...
    public function get_submited_student_idea($student_id,$question_id,$modle_id)
    {
        $this->db->from('idea_student_ans');
    ...
    public function get_idea_information_tutor($idea_id,$tutor_id,$idea_no)
    {
        $this->db->from('idea_tutor_ans');

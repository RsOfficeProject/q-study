   ...
   <div class="col-sm-12">
     <div class="idea_setting_mid">
      ...
      <input type="checkbox" name="short_question_allow" value="1" class="short_question_checkbox"> <label id='shot_question_box'>   <img src="assets/images/icon_new.png"> New
         ...
         <div class="form-group" style="float: left;margin-right: 10px;"> 
            <div>
              <button type="button" class="btn btn-select  ">Student Title <input type="checkbox" name="student_title" value="1" ></button>
            </div> 
         </div>
     ...
     <div class = "all_idea">
      ...
      foreach($all_idea as  $ideas){?>
         ...
         <div class="form-group" style="float: left;margin-right: 10px;">
            ...
            <div>
              <button id="idea1" class="btn btn-select-border">Idea- </button>
            </div> 
         </div>
        <?php }
             ...
             <div id="advance_searc_content">
                <div class="serach_list"> 
                    <div class="input-group">
                      <input type="search" class="form-control" placeholder="Search" name="search" id="advance_searc_content_src" value="">
    ...
    <div  style="background-color: #e1cbcb;" class="modal-content">
      ...
      <div class="modal-header">
        <h4 style="background-color: #e1cbcb; color:#4732e9">Idea
            ...
            <button style="float: right; color:black;background-color: #e1cbcb;border:none;" type="button" data-dismiss="modal"><i class="fa fa-times" aria-hidden="true"></i></button>
        </h4>
      </div>
      ...
      <form class="">
        <div class="modal-body">
          ...
          <button class="ideabtnclose" type="button" style="font-weight:normal;border:none;padding:8px 15px;border-radius:5px;">save</button>
          </div>
        </div>
    </div>
  </div>
    ...
    <div  style="background-color: #e1cbcb;" class="modal-content">
      ...
      <form class="">
        <div class="modal-body">
          ...
          <div style="text-align: right;">
          <button class="viewideabtnclose" type="button" style="font-weight:normal;border:none;padding:8px 15px;border-radius:5px;">save</button>
          </div>
        </div>
    </div>
  </div>
    ...
    <div  style="background-color: #e1cbcb;" class="modal-content">
      ...
      <form class="">
        <div class="modal-body">
          ...
          <button class="imageideatitleclose" type="button" style="font-weight:normal;border:none;padding:8px 15px;border-radius:5px;">save</button>
          </div>
        </div>
    </div>
  </div>
    ...
    $.ajax({
          ...
          success: function (data) {
            ...
            html ='';
              ...
              for(i=0;i<all_data['questions'].length;i++){
              html +='<br><a class="search_button" type="button"  data-id="'+all_data['questions'][i].question_id+'" data-index="'+all_data['questions'][i].id+'">'+all_data['questions'][i].image_title+'</a>';
              }

            $("#image_search_view").css('display', 'block');
  ...
  $(document).on('click','.search_button',function(){
    ...
    $.ajax({
          ...
          success: function (response) {
            ...
            $('#idea1').css({"background-color":"#00a2e8;","color":"white;"});
   ...
   $(document).on('click','.Update_short_question',function(){
     ...
     $.ajax({
          ...
          type: "POST",
          data: {question_id:question_id,short_question:short_question},
          success: function (response) {
            if(response == 1){
  ...
  $(".edit_close_idea").click(function(){
    ...
    var idea_id = $('#edit_idea_id').val();
        ...
        $.ajax({
          url: "edit_save_idea",
          type: "POST",
          data: {idea_title:idea_title,question_description:question_description,total_word:total_word,idea_id:idea_id},
          success: function (response) {
          alert("idea Updated");

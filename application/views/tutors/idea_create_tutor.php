                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="<?php if($student_idea['teacher_correction']!=0){echo "background-color: #a7a4a4;";}?>">
                          <a href="<?php echo base_url('tutor/idea_create_student_details/');echo $student_idea['id'].'/'.$student_idea['student_id'].'/'.$student_idea['question_id']; ?>"> <img src="assets/images/icon_details.png"> </a>
                        </td>
                        <td>

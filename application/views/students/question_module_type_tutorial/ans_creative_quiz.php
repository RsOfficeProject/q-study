                        	 ...
                        	 <div class="btm_word_limt">
                               ...
                               <form id="creative_ans_save" method="post">
                                 ...
                                 <?php } ?>
                                     ...
                                     <textarea id="word_count" class="form-control preview_main_body mytextarea" name="preview_main_body"><?php if(!empty($idea_info[0]['time_hour']) || !empty($idea_info[0]['time_min']) || !empty($idea_info[0]['time_sec'])){?><elem id="time_image"><img  class="image-editor" style="padding-left: 20%;" data-height="250" data-width="200" height="179" src="http://qstudy.test/assets/images/pv1.jpg" width="281" /></elem><?php }?></textarea>

                            ...
                            foreach ($course_details as $course) {
                                ...
                                <li class="text-left">
                                    ...
                                    <p class="text-right filled-in checkbox_place">
                                        <input class="form-check-input"  id="course_<?php echo $i; ?>"type="checkbox" name="course[]" value="<?php echo $course['id'] ?>" data='<?php echo $course['courseCost'] ?>' onclick="courseClick('<?php echo $course['id'] ?>');"  <?= (in_array($course['id'],$register_course))?'disabled':'';?>></p>
                                </li>
                            <?php }
                        } ?>
                    </ul>

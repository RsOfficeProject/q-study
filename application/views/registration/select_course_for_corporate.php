                            ...
                            foreach ($course_details as $course) {
                                ...
                                <li class="text-left" style="position:relative">
                                    ...
                                    <p class="text-right filled-in checkbox_place">
                                        ...
                                        data='<?php echo $course['courseCost'] ?>' onclick="courseClick('<?php echo $course['id'] ?>');"  <?= ($course['id']==52)?'checked':'';?>  <?= (in_array($course['id'],$register_course))?'disabled':'';?> >
                                    </p>
                                </li>
                            <?php }
                        } ?>
...
<!-- <script type="text/javascript">
    document.getElementById('corporate_form').submit();
</script> -->
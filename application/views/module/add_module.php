...
<script>
  ...
  $(document).on('submit', '#addModuleForm', function(e) {
    ...
    x = sorted_arr.sort(function(a, b) {
      return a - b
    });
        ...
        open: function(event, ui) {
          ...
          $('.instruction_textarea').ckeditor({
            ...
            toolbar: [{
              ...
              {
                name: 'basicstyles',
                items: ['Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', '-', 'SImage', 'SPdf', 'SDoc', 'SVideo']
              },
              '/',
              {
                name: 'document',
                items: ['RemoveFormat', 'Maximize', 'ShowBlocks', 'TextColor', 'BGColor', '-', 'Templates', 'Link', 'Image', 'addFile']
              },
              '/',
              {
                name: 'styles',
        ...
        open: function(event, ui) {
          ...
          $('.instruction_textarea').ckeditor({
            ...
            toolbar: [{
              ...
              {
                name: 'basicstyles',
                items: ['Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', '-', 'SImage', 'SPdf', 'SDoc']
              },
              '/',
              {
                name: 'document',

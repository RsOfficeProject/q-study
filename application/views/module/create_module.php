...
<div>
  ...
  <div class="">
    ...
    <form action="save_new_module_question" method="post">
        ...
        <div class="col-sm-11">
          ...
          <div class="ss_question_add_top">
            ...
            <div class="form-group" style="float: left;margin-right: 10px;">
              <button type="button" class="btn btn-default">
                <label for="formInputButton">Show <span><input type="checkbox" name="show_student" id="formInputButton" value="1"></span> </label>
              </button>
            </div>
            ...
            <div class="form-group" style="float: left;margin-right: 10px;">
              ...
              <select class="form-control createQuesLabel subject select2" name="moduleType" id="subject" onchange="getChapter(this)">
            ...
            <a class="ss_q_btn btn pull-left " href="#"><i class="fa fa-remove" aria-hidden="true"></i> Edit</a>
            <a class="ss_q_btn btn pull-left " href="#"><i class="fa fa-remove" aria-hidden="true"></i> Delete</a>

            <input type="submit" class="btn btn-danger ss_q_btn" value="Save" />
          ...
          <div class="row panel-box">
            ...
            foreach ($question_list as $key => $list) : ?>
              <div class="col-sm-2 box box_<?= $key; ?>" data-id="<?= $key; ?>" data-type="<?= $list['questionType']; ?>" data-qid="<?= $list['id']; ?>">

                <div class="panel panel-default">
                  <div class="panel-heading"><a href="">Edit</a>
                    <div class="row">
                      <div class="col-sm-6 pull-right">
                        Q<input type="text" style="width: 50px;" class="text-center question_sorting" value="<?= $list['order']; ?>" 
                        data-tblid="<?= $list['tbl_id']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="panel-body">
                    <a href="<?php echo base_url('question_edit/' . $list['questionType'] . '/' . $list['id']); ?>" class="btn btn-default">
                      Q <?= $i; ?>
                    </a>
                    <a href="<?php echo base_url('question-list/1'); ?>">
...
<script>
  $(document).on('click', '#questionSetting', function() {
    $('.panel-box').append('<div class="col-sm-2"><div class="panel panel-default panel-box"><div class="panel-heading"><a href="">Edit</a><div class="row">Q<div class="col-sm-6"><select name="" id=""><option value="">1</option><option value="">1</option><option value="">1</option></select></div><div class="col-sm-6"><span class="pull-right"><button class="btn btn-danger removecontentsection" type="button"><i class="glyphicon glyphicon-trash"></i></button></span></div></div></div><div class="panel-body"><a href="<?php echo base_url('question-list/1'); ?>"><img src="assets/images/question.png" class="pull-right"></a></div><div class="panel-footer"></div></div></div>');
  });

   ...
   <div class="col-sm-12">
     ...
     <div class="form-group" style="float: left;margin-right: 10px;">
      <input type="checkbox" name="short_question_allow" value="1" <?php if($idea_info['short_question_allow']==1){echo "checked";}?>> <label id='shot_question_box'>   <img src="assets/images/icon_new.png"> New
         ...
         <div class="form-group" style="float: left;margin-right: 10px;"> 
            <div>
              <button type="button" class="btn btn-select  ">Student Title <input type="checkbox" name="student_title" value="1" <?php if($idea_info['student_title']==1){echo "checked";}?>></button>
            </div> 
         </div>
         ...
         <div class="form-group" style="float: left;margin-right: 10px;"> 
            <div>
              <button type="button" class="btn btn-select  " style="<?php if($idea_info['allows_online']==1){echo "background-color: #df3832;";}else{echo 'background-color: #c7c0c0';}?>">Admin Approval <input type="checkbox" name="student_title" value="1" <?php if($idea_info['allows_online']==1){echo "checked";}?>></button>
            </div> 
         </div>
         ...
         <label id="create_new_idea"> <span><img src="assets/images/icon_new.png"> New</span> </label>
          ...
          <div>
            ...
            foreach($ideas as $idea){ ?>
              <button type="button" style="background:#00a2e8;color:white;" data-id="<?=$idea['question_id']?>" data-value="<?=$idea['idea_no']?>" class="btn btn-select-border view_idea">Idea-<?=$a?></button>
            <?php
             $a++;}
            }else{
             ?>
...
$(document).ready(function(){
  ...
  $(document).on('click','.view_idea',function(){ 
    ...
    $.ajax({
          url: "view_edit_idea",
          type: "POST",
          data: {question_id:question_id,idea_no:idea_no},
          success: function (response) {

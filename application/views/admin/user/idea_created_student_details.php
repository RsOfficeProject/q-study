            ...
            <table class="rs_n_table table table-bordered" ccellspacing="30">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="<?php if($student_idea['by_admin_or_tutor']==1){echo "background-color: #c3c1c1";}?>">
                          <a href="<?php echo base_url('admin/idea_create_student_setting/'.$student_idea['idea_id'].'/'.$student_idea['idea_no'].'/'.$student_idea['question_id'].'/'.$student_idea['student_id'])?>"> <u> <?=$student_idea['submit_date'];?> </u> </a>
                        </td> 
                        <td style="<?php if($student_idea['by_admin_or_tutor']==1){echo "background-color: #c3c1c1";}elseif($student_idea['by_admin_or_tutor']==2){echo "background-color: #8d8686";}?>">
                          <a href="<?php echo base_url('admin/admin_idea_correction_workout/');echo $student_idea['idea_id'].'/'.$student_idea['student_id']; ?>"> <img src="assets/images/icon_details.png"> </a>
                        </td>
                        <td style="<?php if($student_idea['by_admin_or_tutor']==1){echo "background-color: #c3c1c1";}?>">
                        ...
                        <td>
                        <?php 
                          if($student_idea['by_admin_or_tutor']==2){
                         echo $days; }?>
                        </td>
                        <td>
                          <?php 
